...
mixpanel.init("FAKE_TOKEN", {
    debug: true,
    loaded: function() {
        alert("Mixpanel loaded successfully via Browserify/UMD");
    }
});

},{"./mixpanel.umd.js":2}],2:[function(require,module,exports){
(function (global, factory) {
    ...
    */
    ...
    let loader_module__mpglobal = {
        mixpanel: window['mixpanel'] || []
    };

    bootstrap_sdk({
        global_context: loader_module__mpglobal,
        mixpanel: loader_module__mpglobal.mixpanel,
        init_type: 'module'
    });

    var loader_module = loader_module__mpglobal.mixpanel;
