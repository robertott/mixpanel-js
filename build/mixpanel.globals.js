...
function bootstrap_sdk(bootstrap_options) {
    ...
    /** @const */,
        RESERVED_PROPERTIES = [SET_QUEUE_KEY, SET_ONCE_QUEUE_KEY, ADD_QUEUE_KEY, APPEND_QUEUE_KEY, UNION_QUEUE_KEY, PEOPLE_DISTINCT_ID_KEY, ALIAS_ID_KEY, CAMPAIGN_IDS_KEY];
    ...
    MixpanelLib.prototype.track = function (event_name, properties, callback) {
        ...
        if (_.isBlockedUA(userAgent) || this._flags.disable_all_events || _.include(this.__disabled_events, event_name)) {
    ...
    var update_init_func = function update_init_func() {
    ...
    var add_dom_loaded_handler = function add_dom_loaded_handler() {
        ...
        if (document.addEventListener) {
            ...
            if (document.documentElement.doScroll && toplevel) {
                (function () {
                    var do_scroll_check = function do_scroll_check() {
                        try {
